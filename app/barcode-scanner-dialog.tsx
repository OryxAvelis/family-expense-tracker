...
const scannerCopy = {
  fr: {
    ...
    source: "Recherche d’abord dans MyMarket, puis dans Open Food Facts. L’acheteur familial confirme le prix réel.",
  ...
  ar: {
    ...
    source: "يبدأ البحث في MyMarket ثم Open Food Facts. يؤكد مشتري العائلة السعر الحقيقي.",
  ...
  en: {
    ...
    source: "Searches MyMarket first, then Open Food Facts. The family buyer confirms the real price.",
